...
public class BookUI extends JPanel {
   ...
   // label text for GUI
   protected final static String names[] = { "Book Title",
      "Author", "ISBN", "Edition", "Copyright Year", "Price", "Quantity In Stock" };
   ...
   public static final int BOOKTITLE = 0, AUTHOR = 1, ISBN = 2,
      EDITION = 3, COPYRIGHT = 4, PRICE = 5, QUANTITY = 6;

   // Set up GUI. Constructor argument size determines the number of
   // rows of GUI components.
   public BookUI( int mySize )
   {
      size = mySize;
